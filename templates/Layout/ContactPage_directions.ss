<div class="print_me typography">
    <div id="directions_head">
        ...
        <ul id="directions_links">
            <li><a href="$GoogleLink" class="icon_link" target="_blank"><img src="/iq-basepages/images/icons_google.png" />View on Google Maps</a></li>
            <li><a href="$PrintLink" class="icon_link" target="_blank"><img src="/iq-basepages/images/icons_printer_gray.png" />Print these Directions</a></li>
